...
def read_file_to_string(directory, filename):
    ...
    #full_path = directory + "\\" + filename ne delat tega!
...
def page_to_ads(page_content):
    ...
    vrne njih seznam"""
    #print(page_content)
    exp = r'<div class="coloumn content">(.*?)<div class="clear">' #? da najde vsako reklamo posebej, ne pa vse, vse skupaj; pika zajame vse razen novih vrstic, zato dodamo 
...
def get_dict_from_ad_block(block):
    ...
    #DOBIMO SLOVAR SLOVARJEV S TEMI PODATKI
...
def ads_from_file(filename, directory):
    ...
    return [get_dict_from_ad_block(block).groupdict() for block in ads if get_dict_from_ad_block(block)] #groupdict, da ohrani poimenovanje grup
